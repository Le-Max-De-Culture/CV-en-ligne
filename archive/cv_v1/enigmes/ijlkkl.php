...
<input type="text" name="password" id="psw" placeholder="Lettre"/>
...
<p id="response">
  ...
  if (isset($_POST['password'])) {
    $psw = $_POST['password'];
    if ($psw == "m") {
      echo 'Bon message ! Rendez-vous sur la page de la prochaine énigme : <a href="dsaxxvfds.php">link</a>' ;
    }
    else {
