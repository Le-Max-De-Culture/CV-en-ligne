...
<p id="response">
  ...
  if (isset($_POST['password'])) {
    $psw = $_POST['password'];
    if ($psw == "139") {
      echo 'Bravo ! Tu es arrivé au bout ! Rendez-vous sur la page de la surprise qui sera diffusée quand elle devra l\'être ;) : <a href="fin.php">link</a>' ;
    }
    else {
