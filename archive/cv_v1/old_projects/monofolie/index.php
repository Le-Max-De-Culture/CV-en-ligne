...
<!--
<div id="conteneur_global_presentation_accueil">
  <div class="element_1_presentation_accueil">
    <img src="image/logo.png" alt="" width="70%">
  </div>

  <div class="element_2_presentation_accueil">
    <p class="gauche"><h1>MonoFolie</h1></p>
    <p class="droite">Alexis, Célian, Julien, Kilian et Lucas</p>
  </div>
</div>
!-->
<div id="accueil">
...
<h1>MonoFolie</h1>
<h2>Course en Cours 2019</h2>
</div>
<div class="presentation_accueil">
<p>
MonoFolie participe au projet "Course en Cours" !
</br>
